    ...
    <section id="contacto" class="py-24 px-6 relative border-t border-[#1b4d3e]/10 bg-[#040807]/30">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <!-- WhatsApp -->
                @if($settings['phone'])
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['phone']) }}?text={{ urlencode('Hola Kevin, vi tu portafolio y me gustaría ponerme en contacto contigo.') }}" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-8 rounded-2xl bg-[#0b3c2d]/10 backdrop-blur-md border border-[#1b4d3e]/20 hover:border-emerald-500/50 hover:bg-[#0b3c2d]/20 transition-all duration-300 text-center group">
                        <div class="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400 mb-4 group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.413 9.863-9.864.001-2.641-1.03-5.124-2.904-6.999-1.874-1.874-4.361-2.903-7.006-2.904-5.442 0-9.869 4.414-9.873 9.866-.001 1.77.462 3.5 1.34 5.03l-.973 3.56 3.659-.96zm12.31-7.16c-.273-.137-1.62-.8-1.872-.892-.254-.094-.44-.137-.625.137-.184.272-.713.89-.873 1.072-.16.182-.32.203-.593.067-.27-.137-1.143-.42-2.179-1.343-.807-.719-1.349-1.606-1.508-1.878-.159-.272-.016-.418.12-.555.123-.122.272-.32.408-.479.136-.159.182-.272.272-.453.091-.182.046-.341-.023-.479-.068-.137-.625-1.502-.856-2.057-.224-.544-.471-.472-.625-.48l-.532-.008c-.183 0-.482.068-.734.341-.252.272-.962.94-0.962 2.294 0 1.354.984 2.661 1.122 2.843.138.182 1.936 2.956 4.69 4.145.655.282 1.167.45 1.565.577.658.21 1.258.18 1.732.11.528-.078 1.62-.662 1.848-1.3.227-.638.227-1.187.16-1.3-.068-.113-.254-.182-.527-.319z"/>
                            </svg>
                        </div>
                        <span class="text-sm font-semibold text-white mb-1">WhatsApp</span>

    ...
    <section id="contacto" class="py-24 px-6 relative border-t border-[#1b4d3e]/10 bg-[#040807]/30">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <!-- WhatsApp -->
                @if($settings['phone'])
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['phone']) }}{{ !empty($settings['whatsapp_message']) ? '?text=' . urlencode($settings['whatsapp_message']) : '' }}" target="_blank" rel="noopener noreferrer" class="flex flex-col items-center p-8 rounded-2xl bg-[#0b3c2d]/10 backdrop-blur-md border border-[#1b4d3e]/20 hover:border-emerald-500/50 hover:bg-[#0b3c2d]/20 transition-all duration-300 text-center group">
